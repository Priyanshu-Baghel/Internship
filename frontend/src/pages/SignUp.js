...
import logo from '../media/register.jpeg';
        ...
        <div className="absolute inset-0 flex items-center justify-center">
          ...
          <div className="relative">
            <div className="w-full max-w-xl xl:mx-auto xl:w-full xl:max-w-xl xl:pr-24">
              <ul className="mt-80 grid grid-cols-1 gap-x-8 gap-y-4 sm:grid-cols-2">
                <li className="flex items-center space-x-3">
                  <div className="inline-flex h-5 w-5 flex-shrink-0 items-center justify-center rounded-full bg-black">
                    <svg
